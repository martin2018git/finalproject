...
import "PropertyMainInterface.sol"; // import state machine model

contract PropertyMain is PropertyMainInterface {
    ...
    ) external
    {
      ...
      property.monthlylease=0;
      property.unitPrice=0;
      property.totalPoints=0;

      // set initial values
      state = LibPropertySMM.PropertyState.New;
      owner = msg.sender;
      manager = msg.sender;
     ...
     * MODIFIERS
     */
    modifier hasState( LibPropertySMM.PropertyState s ){
      require( state==s );
      _;
    }
        ...
        */
         ...
         */
         function cancelPurchase(
           ...
           returns (bool)
         {
           LibOwnership.unlockAllDeposits(aOwners,mapOwners);
